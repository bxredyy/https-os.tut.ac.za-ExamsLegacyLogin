define("OutSystemsUI.model$SpaceRec", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model"], function (exports, OutSystems, OutSystemsUIModel) {
    ...
    define("OutSystemsUI.model$InlineSVG_InternalConfigRec", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var InlineSVG_InternalConfigRec = (function (_super) {
    __extends(InlineSVG_InternalConfigRec, _super);
    function InlineSVG_InternalConfigRec(defaults) {
    _super.apply(this, arguments);
    }
    InlineSVG_InternalConfigRec.attributesToDeclare = function () {
    return [
    this.attr("UniqueId", "uniqueIdAttr", "UniqueId", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    this.attr("SVGCode", "sVGCodeAttr", "SVGCode", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    this.attr("ExtendedClass", "extendedClassAttr", "ExtendedClass", false, false, OS.Types.Text, function () {
    return "";
    ...
    InlineSVG_InternalConfigRec.init();
    return InlineSVG_InternalConfigRec;
    })(OS.DataTypes.GenericRecord);
    OutSystemsUIModel.InlineSVG_InternalConfigRec = InlineSVG_InternalConfigRec;
    
    });
    define("OutSystemsUI.model$InlineSVG_InternalConfigList", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$InlineSVG_InternalConfigRec"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var InlineSVG_InternalConfigList = (function (_super) {
    __extends(InlineSVG_InternalConfigList, _super);
    function InlineSVG_InternalConfigList(defaults) {
    _super.apply(this, arguments);
    }
    InlineSVG_InternalConfigList.itemType = OutSystemsUIModel.InlineSVG_InternalConfigRec;
    return InlineSVG_InternalConfigList;
    })(OS.DataTypes.GenericRecordList);
    OutSystemsUIModel.InlineSVG_InternalConfigList = InlineSVG_InternalConfigList;
    ...
    define("OutSystemsUI.model$RegisteredCallbackEventsRec", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var RegisteredCallbackEventsRec = (function (_super) {
    __extends(RegisteredCallbackEventsRec, _super);
    function RegisteredCallbackEventsRec(defaults) {
    _super.apply(this, arguments);
    }
    RegisteredCallbackEventsRec.attributesToDeclare = function () {
    return [
    ...
    RegisteredCallbackEventsRec.fromStructure = function (str) {
    return new RegisteredCallbackEventsRec(new RegisteredCallbackEventsRec.RecordClass({
    nameAttr: OS.DataTypes.ImmutableBase.getData(str)
    }));
    };
    RegisteredCallbackEventsRec.init();
    return RegisteredCallbackEventsRec;
    })(OS.DataTypes.GenericRecord);
    OutSystemsUIModel.RegisteredCallbackEventsRec = RegisteredCallbackEventsRec;
    
    });
    define("OutSystemsUI.model$RegisteredCallbackEventsRecord", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$RegisteredCallbackEventsRec"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var RegisteredCallbackEventsRecord = (function (_super) {
    __extends(RegisteredCallbackEventsRecord, _super);
    function RegisteredCallbackEventsRecord(defaults) {
    _super.apply(this, arguments);
    }
    RegisteredCallbackEventsRecord.attributesToDeclare = function () {
    return [
    this.attr("RegisteredCallbackEvents", "registeredCallbackEventsAttr", "RegisteredCallbackEvents", false, false, OS.Types.Record, function () {
    return OS.DataTypes.ImmutableBase.getData(new OutSystemsUIModel.RegisteredCallbackEventsRec());
    }, true, OutSystemsUIModel.RegisteredCallbackEventsRec)
    ].concat(_super.attributesToDeclare.call(this));
    };
    RegisteredCallbackEventsRecord.fromStructure = function (str) {
    return new RegisteredCallbackEventsRecord(new RegisteredCallbackEventsRecord.RecordClass({
    registeredCallbackEventsAttr: OS.DataTypes.ImmutableBase.getData(str)
    }));
    };
    RegisteredCallbackEventsRecord._isAnonymousRecord = true;
    RegisteredCallbackEventsRecord.UniqueId = "b2eeb8f6-9cd2-6079-c0c4-21f6fd8d6d1f";
    RegisteredCallbackEventsRecord.init();
    return RegisteredCallbackEventsRecord;
    })(OS.DataTypes.GenericRecord);
    OutSystemsUIModel.RegisteredCallbackEventsRecord = RegisteredCallbackEventsRecord;
    
    });
    define("OutSystemsUI.model$RegisteredCallbackEventsRecordList", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$RegisteredCallbackEventsRecord"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var RegisteredCallbackEventsRecordList = (function (_super) {
    __extends(RegisteredCallbackEventsRecordList, _super);
    function RegisteredCallbackEventsRecordList(defaults) {
    _super.apply(this, arguments);
    }
    RegisteredCallbackEventsRecordList.itemType = OutSystemsUIModel.RegisteredCallbackEventsRecord;
    return RegisteredCallbackEventsRecordList;
    })(OS.DataTypes.GenericRecordList);
    OutSystemsUIModel.RegisteredCallbackEventsRecordList = RegisteredCallbackEventsRecordList;
    ...
    define("OutSystemsUI.model$InlineSVG_InternalConfigRecord", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$InlineSVG_InternalConfigRec"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var InlineSVG_InternalConfigRecord = (function (_super) {
    __extends(InlineSVG_InternalConfigRecord, _super);
    function InlineSVG_InternalConfigRecord(defaults) {
    _super.apply(this, arguments);
    }
    InlineSVG_InternalConfigRecord.attributesToDeclare = function () {
    return [
    this.attr("InlineSVG_InternalConfig", "inlineSVG_InternalConfigAttr", "InlineSVG_InternalConfig", false, false, OS.Types.Record, function () {
    return OS.DataTypes.ImmutableBase.getData(new OutSystemsUIModel.InlineSVG_InternalConfigRec());
    }, true, OutSystemsUIModel.InlineSVG_InternalConfigRec)
    ].concat(_super.attributesToDeclare.call(this));
    };
    InlineSVG_InternalConfigRecord.fromStructure = function (str) {
    return new InlineSVG_InternalConfigRecord(new InlineSVG_InternalConfigRecord.RecordClass({
    inlineSVG_InternalConfigAttr: OS.DataTypes.ImmutableBase.getData(str)
    }));
    };
    InlineSVG_InternalConfigRecord._isAnonymousRecord = true;
    InlineSVG_InternalConfigRecord.UniqueId = "7c416001-ce97-9a58-57a1-237e54d11a88";
    InlineSVG_InternalConfigRecord.init();
    return InlineSVG_InternalConfigRecord;
    })(OS.DataTypes.GenericRecord);
    OutSystemsUIModel.InlineSVG_InternalConfigRecord = InlineSVG_InternalConfigRecord;
    
    });
    define("OutSystemsUI.model$InlineSVG_InternalConfigRecordList", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$InlineSVG_InternalConfigRecord"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var InlineSVG_InternalConfigRecordList = (function (_super) {
    __extends(InlineSVG_InternalConfigRecordList, _super);
    function InlineSVG_InternalConfigRecordList(defaults) {
    _super.apply(this, arguments);
    }
    InlineSVG_InternalConfigRecordList.itemType = OutSystemsUIModel.InlineSVG_InternalConfigRecord;
    return InlineSVG_InternalConfigRecordList;
    })(OS.DataTypes.GenericRecordList);
    OutSystemsUIModel.InlineSVG_InternalConfigRecordList = InlineSVG_InternalConfigRecordList;
    ...
    this.attr("ariaLabelText", "ariaLabelTextAttr", "ariaLabelText", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    ...
    this.attr("emptyValue", "emptyValueAttr", "emptyValue", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    ...
    this.attr("searchFormLabel", "searchFormLabelAttr", "searchFormLabel", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    this.attr("searchGroup", "searchGroupAttr", "searchGroup", false, false, OS.Types.Text, function () {
    return OutSystemsUIModel.staticEntities.booleanTypes.unset;
    }, true), 
    this.attr("searchNormalize", "searchNormalizeAttr", "searchNormalize", false, false, OS.Types.Text, function () {
    return OutSystemsUIModel.staticEntities.booleanTypes.unset;
    }, true), 
    ...
    this.attr("showDropboxAsPopup", "showDropboxAsPopupAttr", "showDropboxAsPopup", false, false, OS.Types.Text, function () {
    return OutSystemsUIModel.staticEntities.booleanTypes.unset;
    }, true), 
    ...
    this.attr("textDirection", "textDirectionAttr", "textDirection", false, false, OS.Types.Text, function () {
    return "";
    }, true), 
    ...
    define("OutSystemsUI.model$RegisteredCallbackEventsList", ["exports", "OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.model$RegisteredCallbackEventsRec"], function (exports, OutSystems, OutSystemsUIModel) {
    var OS = OutSystems.Internal;
    var RegisteredCallbackEventsList = (function (_super) {
    __extends(RegisteredCallbackEventsList, _super);
    function RegisteredCallbackEventsList(defaults) {
    _super.apply(this, arguments);
    }
    RegisteredCallbackEventsList.itemType = OutSystemsUIModel.RegisteredCallbackEventsRec;
    return RegisteredCallbackEventsList;
    })(OS.DataTypes.GenericRecordList);
    OutSystemsUIModel.RegisteredCallbackEventsList = RegisteredCallbackEventsList;
    ...
    get: function () {
    return getRegisteredCallbackEventsRecord("0b93de32-3205-42d0-b874-abafc9221c09");
    }
    });
    
    Object.defineProperty(OutSystemsUIModel.staticEntities.registeredCallbackEvents, "onChange", {
    get: function () {
    return getRegisteredCallbackEventsRecord("24ff52ea-dced-421a-9ba9-cc0ade648dce");
    }
    });
    
    Object.defineProperty(OutSystemsUIModel.staticEntities.registeredCallbackEvents, "initialized", {
    get: function () {
    return getRegisteredCallbackEventsRecord("657dbd86-23d4-4132-9acc-01c9f7d47ed7");
    }
    });
    
    Object.defineProperty(OutSystemsUIModel.staticEntities.registeredCallbackEvents, "rangeSlider_OnValueChange", {
    get: function () {
    return getRegisteredCallbackEventsRecord("b6957b89-cd1c-4aa7-a28b-786dbcc167cb");
    }
    });
    
    Object.defineProperty(OutSystemsUIModel.staticEntities.registeredCallbackEvents, "onSelected", {
    get: function () {
    return getRegisteredCallbackEventsRecord("c5b265c4-3734-4503-8112-fd5d484e16a6");
    }
    });
    
    Object.defineProperty(OutSystemsUIModel.staticEntities.registeredCallbackEvents, "onToggle", {
    get: function () {
    return getRegisteredCallbackEventsRecord("da8d5bce-e4b0-44dd-8705-b8269639d13c");
    }
    });
