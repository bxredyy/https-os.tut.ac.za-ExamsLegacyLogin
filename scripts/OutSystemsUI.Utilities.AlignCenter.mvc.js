define("OutSystemsUI.Utilities.AlignCenter.mvc$model", ["OutSystems/ClientRuntime/Main", "OutSystemsUI.model"], function (OutSystems, OutSystemsUIModel) {
    ...
    return new OS.Model.ModelFactory(Model, "Utilities.AlignCenter");
    });
    ...
    define("OutSystemsUI.Utilities.AlignCenter.mvc$controller", ["OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.controller", "OutSystemsUI.languageResources", "OutSystemsUI.Utilities.AlignCenter.mvc$translationsResources"], function (OutSystems, OutSystemsUIModel, OutSystemsUIController, OutSystemsUILanguageResources, OutSystemsUI_Utilities_AlignCenter_mvc_TranslationsResources) {
    var OS = OutSystems.Internal;
