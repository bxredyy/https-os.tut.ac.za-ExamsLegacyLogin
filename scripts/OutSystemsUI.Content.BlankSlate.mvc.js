define("OutSystemsUI.Content.BlankSlate.mvc$model", ["OutSystems/ClientRuntime/Main", "OutSystemsUI.model"], function (OutSystems, OutSystemsUIModel) {
    ...
    return new OS.Model.ModelFactory(Model, "Content.BlankSlate");
    });
    ...
    define("OutSystemsUI.Content.BlankSlate.mvc$controller", ["OutSystems/ClientRuntime/Main", "OutSystemsUI.model", "OutSystemsUI.controller", "OutSystemsUI.languageResources", "OutSystemsUI.Content.BlankSlate.mvc$translationsResources"], function (OutSystems, OutSystemsUIModel, OutSystemsUIController, OutSystemsUILanguageResources, OutSystemsUI_Content_BlankSlate_mvc_TranslationsResources) {
    var OS = OutSystems.Internal;
